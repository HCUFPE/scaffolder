...
## Purpose
Correlação de requisições via requestId, emissão de logs estruturados (JSON em produção e formatados em desenvolvimento) e higienização/redação de dados sensíveis e credenciais.
