# reference-module-guidance Specification

## Purpose
Diretrizes e documentação técnica para estudo, extensão, renomeação ou remoção segura do módulo de referência (`tasks`), acompanhado por testes automatizados em múltiplas camadas.
