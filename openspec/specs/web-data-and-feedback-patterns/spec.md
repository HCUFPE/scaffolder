# web-data-and-feedback-patterns Specification

## Purpose
Padrões de gerenciamento de dados remotos (TanStack Query), validação consistente de formulários (React Hook Form + Zod), estados visuais de feedback (loading, empty, error, success) e suporte a tema claro, escuro e responsividade.
