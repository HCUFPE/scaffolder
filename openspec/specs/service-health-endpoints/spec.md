# service-health-endpoints Specification

## Purpose
Exposição de endpoints HTTP dedicados para verificação de processo vivo (/health/live) e prontidão de atendimento com verificação de banco de dados (/health/ready).
