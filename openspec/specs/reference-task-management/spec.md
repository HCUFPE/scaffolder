# reference-task-management Specification

## Purpose
Módulo de referência para gerenciamento de tarefas (`tasks`) com ciclo CRUD completo, controle de propriedade (*ownership*), regras de negócio de transição e prazo, remoção lógica (*soft delete*) e interface web integrada com TanStack Query.
