# backend-access-control Specification

## Purpose
Controle de acesso no backend com proteção de rotas por padrão, verificação rigorosa de papéis (`RolesGuard`) e políticas que impedem escalada de privilégios em autoatendimento.
