# versioned-rest-contract Specification

## Purpose
Padronização do contrato REST versionado com prefixo /api/v1, validação global de DTOs, envelope de erro (Problem Details), paginação, serialização de datas UTC e proteção CSRF.
