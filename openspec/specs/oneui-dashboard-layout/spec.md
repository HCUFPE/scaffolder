# oneui-dashboard-layout Specification

## Purpose
Padrões visuais e estruturais de layout e UX inspirados no OneUI: sidebar categorizada com divisórias em caixa alta, cabeçalho superior com barra de busca e dropdown de perfil de usuário em mini-card, e dashboard com hero de boas-vindas e blocos de estatísticas em duas camadas (métricas no topo e atalho no rodapé).
